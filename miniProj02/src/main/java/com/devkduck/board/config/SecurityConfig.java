package com.devkduck.board.config;



import java.net.URLEncoder;

import com.devkduck.board.user.AuthFailureHandler;
import com.devkduck.board.user.AuthSucessHandler;
...
import com.devkduck.board.user.UserService;
...
//		http.csrf().csrfTokenRepository(CookieCsrfTokenRepository.withHttpOnlyFalse());
		...
		.antMatchers("/","/introduce/introduce","/login/loginForm","/login/signupPage","/signup","/update", "/js/**","/css/**","/image/**").permitAll() // 해당 경로들은 접근을 허용
